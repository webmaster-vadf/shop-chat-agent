  ...
  const ShopAIChat = {
    ...
    UI: {
      ...
      displayEmbeddedUrls: function (urls) {
        ...
        const embeddedUrlsContainer = document.createElement("div");
        embeddedUrlsContainer.classList.add("shop-ai-embedded-urls");
    ...
    API: {
      ...
      handleStreamEvent: function (
        ...
        switch (data.type) {
          ...
          case "embedded_urls":
            ShopAIChat.UI.displayEmbeddedUrls(data.urls);
            break;
    ...
    Product: {
      ...
      addProductToCart: function (productTitle) {
        ...
        if (input) {
          input.value = `Add ${productTitle} to my cart`;
